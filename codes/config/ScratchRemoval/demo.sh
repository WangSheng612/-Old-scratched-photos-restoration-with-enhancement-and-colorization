...
# for multiple GPUs
 python3 -m torch.distributed.launch --nproc_per_node=2 --master_port=6512 train.py -opt=options/train/ir-sde.yml --launcher pytorch
...
python test.py '-opt=options/test/ir-sde-noise.yml'
